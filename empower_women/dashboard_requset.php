...
$help_cat = strip_tags($_GET['data_type']);


echo "<h2>Help Category: $help_cat</h2>";


$result = $db->prepare("SELECT * FROM posts where help_category=:help_category order by id desc");
$result->execute(array(':help_category' =>$help_cat));

$count_post = $result->rowCount();
if($count_post ==0){
echo "<div style='background:red;color:white;padding:10px;border:none;'>No Offer has been Posted on this Category <b>($help_cat)</b> Yet.. <b></b></div>";
}
