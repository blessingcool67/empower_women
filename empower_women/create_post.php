...
var datasend = {title:title, offering:offering, messaging:messaging, help_category:help_category,image_link:image_link};	
		$.ajax({
...
<input type="radio" class="offering" name="offering" value="Offering Help" checked/> Offering Help
</div>
<br>
<div class="col-sm-12 form-group">
<label>Help Category</label>
<select class="form-control col-sm-12" id="help_category" name="help_category" required>
<option value="">-- Select Help Category Type --</option>
<option value="Motivational_Quotes">Motivational Quotes</option>
<option value="Jobs_Internship">Jobs/Internship</option>
...
<input  class="form-control contact_input_color" id="title" name="title" placeholder="Post Title" type="text" value="Women in Cloud Hiring Women IT Technology Experts" required>
</div>
...
<textarea  class="form-control contact_input_color" id="messaging" name="messaging" placeholder="Post Description"  required>
Women in Cloud is currently seeking for Women who are grounded in Hardware Engineering and System Repairers. If you are a woman with atleast 1 year experience. We at Avanade needs you on Board.</textarea>
</div>



<div class="col-sm-12 form-group">
<label>Public Accessible Image URL Link <span style='color:red'>(Optional)</span></label>
<input  class="form-control contact_input_color" id="image_link" name="image_link" placeholder="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/1_kath_afzali.jpg/220px-1_kath_afzali.jpg" type="text" >
</div>
