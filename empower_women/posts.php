...
$image_link = strip_tags($_POST['image_link']);
...
(title,title_seo,content,timer1,timer2,username,fullname,userphoto,userid,points,help_category,offering,total_comments,data_type,images)
                        values
(:title,:title_seo,:content,:timer1,:timer2,:username,:fullname,:userphoto,:userid,:point, :help_category,:offering,:total_comments,:data_type,:images)');
