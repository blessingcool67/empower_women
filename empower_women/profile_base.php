...
$request_userid=htmlentities(htmlentities($_SESSION['uid'], ENT_QUOTES, "UTF-8"));
...
<h3><center>Your Profiles/Posts</center></h3>
<div class='col-sm-6'>
<img style='max-height:200px;max-width:200px;' class='img-rounded' width='200px' height='200px' src='uploads/<?php echo htmlentities(htmlentities($_SESSION['photo'], ENT_QUOTES, "UTF-8")); ?>'>
<br>
</div>
<div class='col-sm-6'>
<b> Name:</b> <?php echo htmlentities(htmlentities($_SESSION['fullname'], ENT_QUOTES, "UTF-8")); ?>
<br>
<b style='font-size:16px;'> Email:</b> <?php echo htmlentities(htmlentities($_SESSION['email'], ENT_QUOTES, "UTF-8")); ?><br>
<b style='font-size:16px;'> Status:</b> You<br>
<b style='font-size:16px;color:green'> Awarded  Points:</b> <span title='Awarded Points:(<?php echo htmlentities(htmlentities($_SESSION['points'], ENT_QUOTES, "UTF-8")); ?>) ' class='point_count'><?php echo htmlentities(htmlentities($_SESSION['points'], ENT_QUOTES, "UTF-8")); ?></span><br>
<b style='font-size:20px;color:#800000'> Helper Level: <?php echo htmlentities(htmlentities($_SESSION['levels'], ENT_QUOTES, "UTF-8")); ?></b><br>
<b style='font-size:20px;color:#800000'> You Have: <?php echo $st_count; ?> Posts</b><br>

<b style='font-size:16px;display:none;'> Member Since:</b> <?php //echo htmlentities(htmlentities($_SESSION['created_time'], ENT_QUOTES, "UTF-8")); ?><br>
